<template>
  <div>
    ...
    <section class="section-b-space">
                ...
                <div class="row">
                  ...
                  <div class="col-lg-6 rtl-text">
                    <div class="product-right">
                      ...
                      <div v-if="getDetail.stock < 8" class="pro_inventory">
                        <p class="active">
                      ...
                      <div class="product-description border-product">
                        <h6 class="product-title size-text">
                          select size
                          <span>
                            <a v-b-modal.modal-1 href="javascript:void(0)">size chart</a>
                          </span>
                        </h6>
                        <div class="size-box">
                          <ul>
                        ...
                        <h5 v-if="counter <= getDetail.stock" class="avalibility">
                          <span>In Stock</span>
                        </h5>
                        <h5 v-if="counter > getDetail.stock" class="avalibility">
      ...
      <relatedProduct :product-t-ype="productTYpe" :product-id="productId" />
