<template>
  <div class="landingPage">
        ...
        <div class="row">
          <div class="col p-0">
            <div class="top-header">
              ...
              <div id="nav" class="main-menu ml-auto">
                <nav id="navbar-example2" class="navbar navbar-expand-lg navbar-light">
                  ...
                  <div id="scroll-spy" class="collapse navbar-collapse" :class="{ show: opennavmenu}">
                  ...
                  <div>
                    ...
                    >
                      <button class="btn my-sm-0 purchase-btn">
                        PURCHASE
                      </button>
                    </form>
                  </div>
    ...
    <!--header end-->
    <!--home section start-->
    <section id="img-bg" class="main-img responsive-img pt-0">
      <div class="container-fluid">
        ...
        <div class="row">
          <div class="col-12">
            <div class="feature text-center">
              <div>
                <h5 class="title-landing">
                  Reasones to Buy Multikart
                </h5>
                <p class="pb-3">
                  Multikart VUE template is an apparently simple but highly functional tempalate
                  designed for
                  creating
      ...
      <div class="row feature_row">
        <div class="col-xl-3 col-md-6">
          <div class="feature-box">
            ...
            <p class="para">
              We understand priority of social media so we have integrated social login with firebase which you can implement within minutes.
            </p>
          </div>
        </div>
        <div class="col-xl-3 col-md-6 ">
          <div class="feature-box">
            ...
            <p class="para">
              Customizer helps you to Design Unlimited possibilites for your theme so that you can build perfect ecommerce site in Nuxt Js
            </p>
          </div>
        </div>
        <div class="col-xl-3 col-md-6 ">
          <div class="feature-box">
            ...
            <p class="para">
              Emails are basic necessity for any ecommerce site so we provide email html templates so it be easy to implement for your project
            </p>
          </div>
        </div>
        <div class="col-xl-3 col-md-6 ">
          <div class="feature-box">
            ...
            <p class="para">
              Take payment from your customers globally with paypal and stripe.
            </p>
          </div>
        </div>
      </div>
          ...
          <div class="col-12">
            <div class="cart-contain text-center feature">
              ...
              <p
                class="pb-3"
              >
                Multikart has 5+ add to cart vartiation which include left, right, top, bottom, quanitity counter and popup.
              </p>
              <img
          ...
          <div class="col-md-12">
            <div class="text-center">
              ...
              <p
                class="pb-3"
              >
                Multikart include 3 grid view portfolio pages and 4 masonary view portfolio pages.
              </p>
            </div>
          </div>
        </div>
            ...
            <div class="footer-section">
              <div>
                <ul class="rate-section">
                  <li><i class="fa fa-star" aria-hidden="true" /></li>
                  <li><i class="fa fa-star" aria-hidden="true" /></li>
                  <li><i class="fa fa-star" aria-hidden="true" /></li>
                  <li><i class="fa fa-star" aria-hidden="true" /></li>
                  <li><i class="fa fa-star" aria-hidden="true" /></li>
