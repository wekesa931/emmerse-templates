  ...
  <div>
    ...
    <section class="cart-section section-b-space">
      <div class="container">
        <div class="row">
          <div class="col-sm-12">
            <table v-if="cart.length" class="table cart-table table-responsive-xs">
              <thead>
                <tr class="table-head">
                  <th scope="col">
                    image
                ...
                <tr>
                  ...
                  <td>
                    <h2
                      class="td-color"
                    >
                      {{ (item.price * curr.curr) * item.quantity | currency(curr.symbol) }}
                    </h2>
                  </td>
                </tr>
              </tbody>
            </table>
            <table v-if="cart.length" class="table cart-table table-responsive-md">
              <tfoot>
                <tr>
                  <td>total price :</td>
                  <td>
            ...
            <div v-if="!cart.length" class="col-sm-12 empty-cart-cls text-center">
        ...
        <div v-if="cart.length" class="row cart-buttons">
          <div class="col-6">
            <nuxt-link :to="{ path: '/'}" :class="'btn btn-solid'">
              continue shopping
            </nuxt-link>
          ...
          <div class="col-6">
            <nuxt-link :to="{ path: '/page/account/checkout'}" :class="'btn btn-solid'">
              check out
            </nuxt-link>
          </div>
        </div>
