          ...
          <div class="col-lg-6">
              ...
              <div class="typo-content">
                <div class="row">
                  ...
                  <div class="col-sm-6">
                    ...
                    <ul>
                      <li>
                        <i class="fa fa-angle-double-right mr-2" />Lorem ipsum dolor sit amet
                      </li>
                      <li>
                        <i class="fa fa-angle-double-right mr-2" />Lorem ipsum dolor sit amet
                      </li>
              ...
              <div class="typo-content input_button">
                <div class="row">
                  <div class="col-sm-6">
                    <form>
                      <div>
                        <input id="one" type="radio" name="gender" value="male">
                        <label for="one">radio button1</label>
                      </div>
                      <div>
                        <input id="two" type="radio" name="gender" value="male">
                        <label for="two">radio button2</label>
                      </div>
                      <div>
                        <input id="three" type="radio" name="gender" value="male">
                        <label for="three">radio button3</label>
                      </div>
                      <div>
                        <input id="four" type="radio" name="gender" value="male">
                        <label for="four">radio button4</label>
                      </div>
                      <div>
                        <input id="five" type="radio" name="gender" value="male">
                  ...
                  <div class="col-sm-6">
                    <form>
                      <div>
                        <input id="six" type="checkbox" name="gender" value="male">
                        <label for="six">checkbox button1</label>
                      </div>
                      <div>
                        <input id="seven" type="checkbox" name="gender" value="male">
                        <label for="seven">checkbox button2</label>
                      </div>
                      <div>
                        <input id="eight" type="checkbox" name="gender" value="male">
                        <label for="eight">checkbox button3</label>
                      </div>
                      <div>
                        <input id="nine" type="checkbox" name="gender" value="male">
                        <label for="nine">checkbox button4</label>
                      </div>
                      <div>
                        <input id="ten" type="checkbox" name="gender" value="male">
            ...
            <div class="typography-box">
              <div class="headings">
                ...
                <span>
                  Add a
                  <code class="highlighter-rouge">&lt;footer class="blockquote-footer"&gt;</code> for identifying the source. Wrap the name of the source work in
                  <code
