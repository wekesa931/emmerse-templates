<template>
  <div>
    ...
    <section v-if="order!=''" class="section-b-space light-layout">
      <div class="container">
        <div class="row">
          <div class="col-md-12">
    ...
    <section v-if="order!=''" class="section-b-space">
      <div class="container">
        <div class="row">
          <div class="col-lg-6">
            <div class="product-order">
              <h3>your order details</h3>
              <div v-for="(item,index) in order.product" :key="index" class="row product-order-detail">
                <div class="col-3">
