<template>
  <div>
    ...
    <section class="compare-section section-b-space ratio_asos">
      <div class="container">
        <div class="row">
          <div v-if="compare.length" class="col-12">
            <div v-swiper:mySwiper="swiperOption">
              <div class="swiper-wrapper">
                <div v-for="(item,index) in compare" :key="index" class="swiper-slide">
                  <div class="compare-part">
                    ...
                    <div v-if="item.variants[0].color" class="detail-part">
                      <div class="title-detail">
                        <h5>color</h5>
                      </div>
                      <div class="inner-detail">
          ...
          <div v-if="!compare.length" class="col-12 empty-cart-cls text-center">
